...
<div class="dropdown">
    <select onchange="location=value" id="pageSize" name="pageSize">
        ...
        <option value="${contextPath}/search/result?pageNumber=0&pageSize=${totalElements}&searchKey=${searchParams.getSearchKey()}&categoryName=${searchParams.getCategoryName()}&minPrice=${searchParams.getMinPrice()}&maxPrice=${searchParams.getMaxPrice()}">Все</option>
    </select>
    ${pageSize}
</div>